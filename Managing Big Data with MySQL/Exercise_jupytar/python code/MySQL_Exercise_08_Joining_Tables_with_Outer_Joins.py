...
get_ipython().run_cell_magic('sql', '', "SELECT d.user_guid AS UserID, d.dog_guid AS DogID, d.breed, d.breed_type,\nd.breed_group\nFROM dogs d JOIN complete_tests c\nON d.dog_guid=c.dog_guid\nWHERE test_name='Yawn Warm-up';")
...
get_ipython().run_cell_magic('sql', '', 'SELECT d.user_guid AS dUserID, c.user_guid AS cUserID, d.dog_guid AS dDogID,\nc.dog_guid AS dDogID, count(test_name)\nFROM dogs d LEFT JOIN complete_tests c\nON d.dog_guid=c.dog_guid\nGROUP BY d.dog_guid;')
