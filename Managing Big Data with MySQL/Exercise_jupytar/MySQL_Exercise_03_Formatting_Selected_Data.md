...
```python
non_usa = %sql SELECT DISTINCT country FROM users WHERE country!='US';
...
<a href="./files/non_usa_country_ex03_Q5.csv">CSV results</a>
...
```python
nc_after_1st_march_2014=%sql SELECT DISTINCT user_guid, state, created_at FROM users WHERE membership_type=2 AND state="NC" AND country="US" AND created_at>'2014_03_01' ORDER BY created_at DESC;
```
...
<a href="./files/nc_after_1st_march_2014_ex03_Q7.csv">CSV results</a>
